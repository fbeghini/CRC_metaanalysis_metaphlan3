...
ggplot() +
  ...
  scale_color_manual(values = c("#0039A6","#fc9665","#6CBE45","#996633","#a3a3a3","#FCCC0A","#000000","#ff1919","#00933C","#B933AD"), name = 'Dataset') +
  theme_minimal(base_size = 15) + 
  scale_shape_discrete(name = 'Condition')
```


```{r CRC_MDS_sinh_sqrt_normalization, eval=FALSE, fig.height=6, fig.retina=TRUE, fig.width=10, include=FALSE}
mds_res_norm %>% 
  as.data.frame() %>% 
  rownames_to_column('sampleID') %>% 
  left_join(metadata %>%  rownames_to_column('sampleID')) %>% 
