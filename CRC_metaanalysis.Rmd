...
```{r}
full_join(nspecies_mpa2, nspecies_mpa3, suffix = c("_mpa2","_mpa3"), by = "sample") %>%
...
# MDS
```{r calculate MDS}
mds_res_nonorm <- cmdscale(vegdist(t(mpa_table[,-1]), method = 'bray', diag = TRUE, upper = FALSE))
```

```{r CRC_MDS_no_normalization, fig.width=8, fig.height=4.5, fig.retina=TRUE}
mds_res_nonorm %>% 
  as.data.frame() %>% 
...
ML <- tribble(~source, ~dataset, ~AUC, ~type, 
              ...
              "HUMAnN 3\nGene Family","ZellerG_2014", 0.81, "CV",
              "HUMAnN 3\nGene Family","YuJ_2015", 0.78, "CV",
              "HUMAnN 3\nGene Family","FengQ_2015", 0.78, "CV",
              "HUMAnN 3\nGene Family","VogtmannE_2016", 0.63, "CV",
              "HUMAnN 3\nGene Family","WirbelJ_2018", 0.92, "CV",
              "HUMAnN 3\nGene Family","GuptaA_2019", NA, "CV",
              "HUMAnN 3\nGene Family","ThomasAM_2019_a", NA, "CV",
              "HUMAnN 3\nGene Family","ThomasAM_2019_b", 0.71, "CV",
              "HUMAnN 3\nGene Family","YachidaS_2019", NA, "CV",
              "HUMAnN 3\nPathways", "ZellerG_2014",0.81, "CV",
              "HUMAnN 3\nPathways", "YuJ_2015",0.67, "CV",
              "HUMAnN 3\nPathways", "FengQ_2015",0.72, "CV",
              "HUMAnN 3\nPathways", "VogtmannE_2016",0.63, "CV",
              "HUMAnN 3\nPathways", "WirbelJ_2018",NA, "CV",
              "HUMAnN 3\nPathways", "GuptaA_2019",0.95, "CV",
              "HUMAnN 3\nPathways", "ThomasAM_2019_a",0.76, "CV",
              "HUMAnN 3\nPathways", "ThomasAM_2019_b",NA, "CV",
              "HUMAnN 3\nPathways", "YachidaS_2019",0.61, "CV",

    )
ML %>% 
ggplot() + 
  geom_tile(aes(x = type, y=dataset, fill=AUC), width=0.8) + 
  geom_text(aes(x = type, y=dataset, label=signif(AUC,2), color= AUC < 0.73), size=4, fontface = 'bold') +
  theme_cm(panel.grid.major.y = element_blank(),
           strip.text = element_text(angle= 60),
           legend.text = element_text(size = 10),
           legend.title = element_text(size = 10)
         ) +
  colormap::scale_fill_colormap(colormap = 'hot', limits = c(0.5, 1)) +
